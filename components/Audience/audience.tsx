  ...
  return (
    <div className=" pt-[1rem] pb-[1rem] bg-gradient-to-br from-blue-400 to-purple-500 min-h-screen flex flex-col justify-center items-center">
      <div className="max-w-lg w-full p-8 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-lg text-gray-700 mb-6">Our users are individuals who love to immerse themselves in captivating stories, whether they are readers looking for new adventures or writers eager to share their creativity with the world.</p>
